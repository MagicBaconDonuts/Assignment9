package com.assignment9.domain;
...
public class Recipe {
	...
	public void createRecipe(String string, String string2, String string3, String instructions2, String string4,
			String string5, String string6, String string7, String string8, String title2, String string9,
			String string10) {
